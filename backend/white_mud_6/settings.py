"""
Django settings for white_mud_6 project.
...
WSGI_APPLICATION = 'white_mud_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "white_mud_6 API",
    "DESCRIPTION": "API documentation for white_mud_6 App",
    "VERSION": "v1",
}
